...
function WhatsAppIcon(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" {...props}>
      <defs>
        <linearGradient id="whatsapp-b" x1="85.915" x2="86.535" y1="32.567" y2="137.092" gradientUnits="userSpaceOnUse">
...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://github.com/ItikawaBruno",
    icon: GitHubIcon,
  },
  {
    name: "LinkedIn",
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center gap-6 px-6">
        ...
        >
          {socialLinks.map((link) => (
            <DockIcon key={link.name} className="bg-white/5">
              <a
                href={link.href}
                target="_blank"
        ...
        <p className="text-xs text-zinc-600">
          © {new Date().getFullYear()} Bruno Hideki Itikawa. Todos os direitos reservados.
        </p>
      </div>
    </footer>
  )
